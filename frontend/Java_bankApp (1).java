...
/**
 * Java_bank ATM Banking Application
 ...
 *         -d out src/com/java_bank/atm/Java_bankApp.java
 *
 * Run:
 *   java --module-path <javafx-sdk>/lib --add-modules javafx.controls,javafx.graphics \
 *        -cp out com.java_bank.atm.Java_bankApp
 */
public class Java_bankApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Java_bank — Secure Banking");
        stage.setWidth(1100);
        stage.setHeight(700);
    ...
    private void showSplashScreen() {
        ...
        Label corner = new Label("© 2025 Java_bank Financial Systems Ltd.");
    ...
    private VBox buildLogoText() {
        ...
        Text javaSpaced = new Text("JAVA");
        javaSpaced.setFont(Font.font("System", FontWeight.BOLD, 38));
        javaSpaced.setFill(TEXT_PRIMARY);

        Text bankSpaced = new Text("BANK");
        bankSpaced.setFont(Font.font("System", FontWeight.BOLD, 38));
        bankSpaced.setFill(ACCENT_PRIMARY);

        // Subtle emerald text glow on BANK
        DropShadow textGlow = new DropShadow();
        textGlow.setColor(Color.web("#10B981", 0.5));
        textGlow.setRadius(12);
        bankSpaced.setEffect(textGlow);

        logoRow.getChildren().addAll(javaSpaced, bankSpaced);
    ...
    private HBox buildSecurityBadge() {
        ...
        Label txt = new Label("Secured by Java_bank Security Suite");
    ...
    private StackPane buildFormPanel() {
        ...
        Label subtitle = new Label("Sign in to your Java_bank account");
